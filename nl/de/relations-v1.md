...
In der folgenden Tabelle sind die Beziehungstypen aufgelistet, die vom Beziehungstypsystem _Version 1_ zurückgegeben werden. Welches Beziehungstypsystem {{site.data.keyword.nlushort}} verwendet, ist von der verwendeten Sprache abhängig. Weitere Details hierzu finden Sie auf der Seite [Beziehungstypsysteme](/docs/services/natural-language-understanding?topic=natural-language-understanding-relation-type-systems).
{: shortdesc}

Im Typsystem _Version 1_ werden in den Beziehungsergebnissen andere Entitätstypen zurückgegeben als in den Entitätsergebnissen. Eine Liste der Entitätstypen, die in Beziehungen bei _Version 1_ verwendet werden, finden Sie auf der Seite [Entitätstypen (Version 1)](/docs/services/natural-language-understanding?topic=natural-language-understanding-entity-types-version-1#relations-entity-types).
{: note}
