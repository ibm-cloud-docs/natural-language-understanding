...
使用すべき認証を調べるには、[{{site.data.keyword.cloud_notm}} リソース・ページ ![外部リンク・アイコン](../../icons/launch-glyph.svg "外部リンク・アイコン")](https://{DomainName}/resources){: new_window} でサービス・インスタンスをクリックしてサービス資格情報を参照します。
