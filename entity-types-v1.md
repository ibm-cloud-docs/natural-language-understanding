...
The entity type system that {{site.data.keyword.nlushort}} uses differs based on which version date and which language you are using. For more details, see the [Entity type systems](/docs/natural-language-understanding?topic=natural-language-understanding-entity-type-systems) page.
