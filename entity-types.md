...
For example, analyzing entities in French text with version date set to `2018-03-16` will use the [Version 2 entity type system][v2]. Requests that specify a previous version date will use the [Version 1 entity type system][v1].
